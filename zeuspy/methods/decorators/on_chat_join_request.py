...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~zeuspy.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, zeuspy.Client):
                self.add_handler(zeuspy.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        zeuspy.handlers.ChatJoinRequestHandler(func, self),
