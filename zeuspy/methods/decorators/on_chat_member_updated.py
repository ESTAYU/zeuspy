...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~zeuspy.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, zeuspy.Client):
                self.add_handler(zeuspy.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        zeuspy.handlers.ChatMemberUpdatedHandler(func, self),
