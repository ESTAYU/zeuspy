...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~zeuspy.types.InputMediaPhoto`, :obj:`~zeuspy.types.InputMediaVideo`, :obj:`~zeuspy.types.InputMediaAudio` and :obj:`~zeuspy.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~zeuspy.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from zeuspy.types import InputMediaPhoto, InputMediaVideo
