...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~zeuspy.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~zeuspy.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~zeuspy.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "zeuspy". Get the first 50 results
                async for message in app.search_global("zeuspy", limit=50):
                    print(message.text)
