...
import zeuspy
from zeuspy import raw, utils, enums
...
class SendMessage:
    async def send_message(
        ...
        Returns:
            :obj:`~zeuspy.types.Message`: On success, the sent text message is returned.

        Example:
            .. code-block:: python

                # Simple example
                await app.send_message("me", "Message sent with **zeuspy**!")

                # Disable web page previews
                await app.send_message("me", "https://docs.zeuspy.org",
                ...
                await app.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [InlineKeyboardButton("Docs", url="https://docs.zeuspy.org")]
                        ]))
        """
