...
from zeuspy.connection import Connection
from zeuspy.crypto import aes, rsa, prime
from zeuspy.errors import SecurityCheckMismatch
from zeuspy.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "zeuspy.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
