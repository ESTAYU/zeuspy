...
from zeuspy.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "zeuspy.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~zeuspy.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~zeuspy.handlers.MessageHandler` the *update* argument will be a :obj:`~zeuspy.types.Message`; in a :obj:`~zeuspy.handlers.CallbackQueryHandler` the *update* will be a :obj:`~zeuspy.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~zeuspy.filters.command` or :meth:`~zeuspy.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~zeuspy.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~zeuspy.types.Document` objects."""
...
"""Filter messages that contain :obj:`~zeuspy.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~zeuspy.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~zeuspy.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~zeuspy.types.Game` objects."""
...
"""Filter messages that contain :obj:`~zeuspy.types.Video` objects."""
...
"""Filter messages that contain :obj:`~zeuspy.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~zeuspy.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~zeuspy.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~zeuspy.types.Location` objects."""
...
"""Filter messages that contain :obj:`~zeuspy.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~zeuspy.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~zeuspy.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~zeuspy.types.Message`.
    ...
    async def func(flt, client: zeuspy.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~zeuspy.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~zeuspy.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~zeuspy.types.InlineQuery`: The filter will match ``query``.
