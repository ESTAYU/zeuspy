...
The next few steps serve as a quick start to see zeuspy in action as fast as possible.

Get zeuspy Real Fast
----------------------
...
1. Install zeuspy with ``pip3 install -U zeuspy``.
    ...
    .. code-block:: python
        ...
        async def main():
            async with Client("my_account", api_id, api_hash) as app:
                await app.send_message("me", "Greetings from **zeuspy**!")
...
8. Watch zeuspy send a message to yourself.
