...
With :meth:`~zeuspy.Client.add_handler` (without decorators) the same can be achieved with:
...
groups priority policy described above. Even in case any handler raises an unhandled exception, zeuspy will still
...
.. code-block:: python
    ...
    from zeuspy import StopPropagation
...
.. code-block:: python
    ...
    from zeuspy import ContinuePropagation
