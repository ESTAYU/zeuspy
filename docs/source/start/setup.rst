...
We have just :doc:`installed zeuspy <../intro/install>`. In this page we'll discuss what you need to do in order to set up a
...
Having the API key from the previous step in handy, we can now begin to configure a zeuspy project: pass your API key to zeuspy by using the *api_id* and *api_hash* parameters of the Client class:
